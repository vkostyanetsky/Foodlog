...
Во-первых, каждое утро я взвешиваюсь и записываю в журнал веса (`scale.yaml`) текущее значение.
...
Во-вторых, в течении дня я записываю в дневник (`meals.yaml`) всё, что съел.
...
Все параметры — в файле `scripts/settings.yaml`. 
