...
Настройка делается через файл `settings.yaml`. В нем можно задать дневной лимит калорий, имя директории для архивных журналов, имя файла журнала и имя файла справочника.
